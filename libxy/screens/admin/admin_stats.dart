  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      ...
      bool isTransactionPayment(app_transaction.Transaction transaction) {
        ...
        final isRefund = transaction.description.toLowerCase().contains(
          'refund',
        );
        final isDeposit = transaction.description.toLowerCase().contains(
          'deposit',
        );
      ...
      try {
        ...
        print(
          'Total energy consumed: ${totalEnergyConsumed.toStringAsFixed(2)} kWh',
        );
      } catch (e) {
        ...
        try {
          ...
          if (estimatedEnergy > 0) {
            ...
            print(
              'Estimated energy consumption from transactions: ${totalEnergyConsumed.toStringAsFixed(2)} kWh',
            );
          }
